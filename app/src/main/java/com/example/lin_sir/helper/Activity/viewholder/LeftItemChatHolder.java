 ...
 */
public class LeftItemChatHolder extends RecyclerView.ViewHolder {
    ...
    public LeftItemChatHolder(Context context, View itemView) {
        super(itemView);
        mContext = context;

        tvTime = (TextView) itemView.findViewById(R.id.tv_chat_item_left_time);
        tvContent = (TextView) itemView.findViewById(R.id.tv_chat_item_left_content);
    }
